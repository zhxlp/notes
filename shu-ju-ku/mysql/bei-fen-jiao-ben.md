...
# 备份目录
backup_path=/data/backup/mysqldump
# 备份文件路径
backup_file=$backup_path/$db_name-$(date "+%Y%m%d%H%M%S").sql.gz
# 日志文件
...
######## 备份数据库 ###########
# mysql
mysqldump --host=$db_host --port=$db_port --user=$db_user --password=$db_pass $db_name | gzip > $backup_file
