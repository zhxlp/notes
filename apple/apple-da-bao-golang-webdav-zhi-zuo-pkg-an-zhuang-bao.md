...
- 访问 packages 官网下载安装包并安装
  ...
  ![image-20200608133012590](../.gitbook/assets/image-20200608133012590.png)

- 下载完成后，运行下载文件，根据提示进行安装

  ![image-20200608140338366](../.gitbook/assets/image-20200608140338366.png)

  ![image-20200608140556876](../.gitbook/assets/image-20200608140556876.png)
...
- 在 Application 中打开 Packages，选择 `Distribution`,点击 Next
  ...
  ![image-20200608140932917](../.gitbook/assets/image-20200608140932917.png)

- 设置工程名称和项目存储目录，点击 Create 创建

  ![image-20200608141104748](../.gitbook/assets/image-20200608141104748.png)

- 配置项目

  ![image-20200608141355771](../.gitbook/assets/image-20200608141355771.png)

  配置安装方式选择 仅标准安装

  ![image-20200608141728298](../.gitbook/assets/image-20200608141728298.png)

  ![image-20200608141827205](../.gitbook/assets/image-20200608141827205.png)

  ![image-20200608141858748](../.gitbook/assets/image-20200608141858748.png)

  ![image-20200608141919715](../.gitbook/assets/image-20200608141919715.png)

  配置安装前和安装后运行脚本

  ![image-20200608141953254](../.gitbook/assets/image-20200608141953254.png)

  保存

  ![image-20200608142034945](../.gitbook/assets/image-20200608142034945.png)

  Build

  ![image-20200608142103399](../.gitbook/assets/image-20200608142103399.png)

  文件生成在项目目录的 build 文件夹中
  ![image-20200608142130069](../.gitbook/assets/image-20200608142130069.png)
...
- 查看可用于签名的证书
  ...
  ![image-20200608225820508](../.gitbook/assets/image-20200608225820508.png)
...
- 查看文件签名
  ...
  ![image-20200608231232796](../.gitbook/assets/image-20200608231232796.png)
...
- 查看 pkg 签名
  ...
  ![image-20200608232605735](../.gitbook/assets/image-20200608232605735.png)
...
- 查询 ProviderShortname
  ...
  ![image-20200608234440030](../.gitbook/assets/image-20200608234440030.png)
...
- 公正
  ...
  ![image-20200608235022003](../.gitbook/assets/image-20200608234812777.png)
...
- 查询公正结果
  ...
  ![image-20200608235204409](../.gitbook/assets/image-20200608235204409.png)
...
- 添加票证到 pkg 文件
  ...
  ![image-20200608235554796](../.gitbook/assets/image-20200608235554796.png)
...
- 查看票证是否添加成功
  ...
  ![image-20200609000027997](../.gitbook/assets/image-20200609000027997.png)

## 参考

[发行前对 Mac OS 软件进行公证](https://developer.apple.com/documentation/xcode/notarizing_macos_software_before_distribution)

[自定义公证工作流程](https://developer.apple.com/documentation/xcode/notarizing_macos_software_before_distribution/customizing_the_notarization_workflow)
